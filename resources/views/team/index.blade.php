...
<head>
    ...
    <link href="{{ asset('/team/css/bootstrap.min.css?v=3.3.5') }}" rel="stylesheet">
    <link href="{{ asset('/team/css/font-awesome.min.css?v=4.4.0') }}" rel="stylesheet">
    <link href="{{ asset('/team/css/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/team/css/style.min.css?v=4.0.0') }}" rel="stylesheet">
</head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="{{ asset('/team') }}/img/profile_small.jpg" /></span>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="{{ asset('/team') }}/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="{{ asset('/team') }}/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                ...
                <div id="tab-2" class="tab-pane">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="{{ asset('/team') }}/img/a7.jpg">
                                </div>
                                <div class="media-body">
...
<script src="{{ asset('/team/js/jquery.min.js?v=2.1.4') }}"></script>
<script src="{{ asset('/team/js/bootstrap.min.js?v=3.3.5') }}"></script>
<script src="{{ asset('/team/js/plugins/metisMenu/jquery.metisMenu.js') }}"></script>
<script src="{{ asset('/team/js/plugins/slimscroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ asset('/team/js/plugins/layer/layer.min.js') }}"></script>
<script src="{{ asset('/team/js/hplus.min.js?v=4.0.0') }}"></script>
<script type="text/javascript" src="{{ asset('/team/js/contabs.min.js') }}"></script>
<script src="{{ asset('/team/js/plugins/pace/pace.min.js') }}"></script>
</body>
