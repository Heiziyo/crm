...
<head>
    ...
    <link href="{{ asset('/admin_style/css/bootstrap.min.css?v=3.3.5') }}" rel="stylesheet">
    <link href="{{ asset('/admin_style/css/font-awesome.min.css?v=4.4.0') }}" rel="stylesheet">
    <link href="{{ asset('/admin_style/css/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/admin_style/css/style.min.css?v=4.0.0') }}" rel="stylesheet">
</head>
...
<script src="{{asset('/admin_style/js/jquery.min.js?v=2.1.4')}}"></script>
<script src="{{asset('/admin_style/js/bootstrap.min.js?v=3.3.5')}}"></script>
<script src="{{asset('/admin_style/js/plugins/metisMenu/jquery.metisMenu.js')}}"></script>
<script src="{{asset('/admin_style/js/plugins/slimscroll/jquery.slimscroll.min.js')}}"></script>
<script src="{{asset('/admin_style/js/plugins/layer/layer.min.js')}}"></script>
<script src="{{asset('/admin_style/js/hplus.min.js?v=4.0.0')}}"></script>
<script type="text/javascript" src="{{asset('/admin_style/js/contabs.min.js')}}"></script>
<script src="{{asset('/admin_style/js/plugins/pace/pace.min.js')}}"></script>
</body>
